...
from Common_tools.utils import Timer, CUDAAggregateTimer
from Common_tools.utils import append_runtime_stats, start_runtime_stats_epoch
        ...
        for epoch in epochs:
            ...
            with Timer((f'Train epoch {epoch}', 'Preamble'),
                ...
                if self.args.train_sampler == 'NeighborSampler':
                    # POINT: シャッフルしworld_sizeで分割されたノードのインデックス（shuffled_idx）を取得。
